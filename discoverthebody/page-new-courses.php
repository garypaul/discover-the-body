								...
								<table class="courses">
									...
									<thead>
										...
										<tr>
											...
											<th>Type <span class="order-container" data-order="taxonomy"><a href="#" class="filter-up" data-orderby="DESC" data-nonce="<?php echo $nonce ?>"></a><a href="#" class="filter-down" data-orderby="ASC" data-nonce="<?php echo $nonce ?>"></a></span></th>
											<th>Duration  <span class="order-container" data-order="date"><a href="#" class="filter-up" data-orderby="DESC" data-nonce="<?php echo $nonce ?>"></a><a href="#" class="filter-down" data-orderby="ASC" data-nonce="<?php echo $nonce ?>"></a></span></th>
											<th>Expiry Date  <span class="order-container" data-order="location"><a href="#" class="filter-up" data-orderby="DESC" data-nonce="<?php echo $nonce ?>"></a><a href="#" class="filter-down" data-orderby="ASC" data-nonce="<?php echo $nonce ?>"></a></span></th>
